/* generated from /home/runner/work/microkit/microkit/seL4/libsel4/sel4_arch_include/riscv64/sel4/sel4_arch/types.bf */
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_VCPUFault_new(seL4_Uint64 cause, seL4_Uint64 data) {
    seL4_Fault_t seL4_Fault;

    /* fail if user has passed bits that we will override */  
    seL4_DebugAssert((data & ~0xffffffffull) == ((0 && (data & (1ull << 63))) ? 0x0 : 0));  
    seL4_DebugAssert(((seL4_Uint64)seL4_Fault_VCPUFault & ~0xfull) == ((0 && ((seL4_Uint64)seL4_Fault_VCPUFault & (1ull << 63))) ? 0x0 : 0));

    seL4_Fault.words[0] = 0
        | (data & 0xffffffffull) << 32
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_VCPUFault_ptr_new(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 cause, seL4_Uint64 data) {
    /* fail if user has passed bits that we will override */  
    seL4_DebugAssert((data & ~0xffffffffull) == ((0 && (data & (1ull << 63))) ? 0x0 : 0));  
    seL4_DebugAssert(((seL4_Uint64)seL4_Fault_VCPUFault & ~0xfull) == ((0 && ((seL4_Uint64)seL4_Fault_VCPUFault & (1ull << 63))) ? 0x0 : 0));
...
LIBSEL4_INLINE_FUNC seL4_Uint64 CONST
seL4_Fault_VCPUFault_get_cause(seL4_Fault_t seL4_Fault) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_VCPUFault_set_cause(seL4_Fault_t seL4_Fault, seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
           seL4_Fault_VCPUFault);
    /* fail if user has passed bits that we will override */
    seL4_DebugAssert((((~0xffffffffffffffffull >> 0 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (63)))) ? 0x0 : 0));
...
LIBSEL4_INLINE_FUNC seL4_Uint64 PURE
seL4_Fault_VCPUFault_ptr_get_cause(seL4_Fault_t *seL4_Fault_ptr) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_VCPUFault);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_VCPUFault_ptr_set_cause(seL4_Fault_t *seL4_Fault_ptr,
                                      seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_VCPUFault);
...
LIBSEL4_INLINE_FUNC seL4_Uint64 CONST
seL4_Fault_VCPUFault_get_data(seL4_Fault_t seL4_Fault) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
           seL4_Fault_VCPUFault);
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_VCPUFault_set_data(seL4_Fault_t seL4_Fault, seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault.words[0] >> 0) & 0xf) ==
           seL4_Fault_VCPUFault);
    /* fail if user has passed bits that we will override */
    seL4_DebugAssert((((~0xffffffff00000000ull >> 32 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (63)))) ? 0x0 : 0));

    seL4_Fault.words[0] &= ~0xffffffff00000000ull;
    seL4_Fault.words[0] |= (v64 << 32) & 0xffffffff00000000ull;
    return seL4_Fault;
}

LIBSEL4_INLINE_FUNC seL4_Uint64 PURE
seL4_Fault_VCPUFault_ptr_get_data(seL4_Fault_t *seL4_Fault_ptr) {
    seL4_Uint64 ret;
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_VCPUFault);

    ret = (seL4_Fault_ptr->words[0] & 0xffffffff00000000ull) >> 32;
    /* Possibly sign extend */
    if (__builtin_expect(!!(0 && (ret & (1ull << (63)))), 0)) {
        ret |= 0x0;
    }
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_VCPUFault_ptr_set_data(seL4_Fault_t *seL4_Fault_ptr,
                                      seL4_Uint64 v64) {
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) ==
           seL4_Fault_VCPUFault);
    ...
    seL4_Fault_ptr->words[0] &= ~0xffffffff00000000ull;
    seL4_Fault_ptr->words[0] |= (v64 << 32) & 0xffffffff00000000ull;
}
